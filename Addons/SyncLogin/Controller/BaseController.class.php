...
class BaseController extends AddonsController
{
    ...
    public function login()
    {
        ...
        if(is_mobile() && ($type == 'weixin')) {
            ...
            $url = "https://open.weixin.qq.com/connect/oauth2/authorize?appid={$config['APP_ID']}&redirect_uri={$redirect}&response_type=code&scope=snsapi_userinfo&state=kmCms#wechat_redirect";
            redirect($url);
            exit;
        } else {
