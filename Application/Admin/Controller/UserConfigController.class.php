...
str;
        ...
        $admin_config->title(L('_USER_CONFIGURATION_'))->data($data)
            ...
            //->keyText('SMS_HTTP', L('_SMS_PLATFORM_HTTP_'), '短信平台HTTP，可用服务商：<a href="http://www.yunsms.cn/" target="_blank">云短信</a>，<a href="http://v2.btcsoft.cn/index.php?s=/news/index/detail/id/52.html" target="_blank">使用帮助</a>')
            ...
            ->keyTextArea('SMS_CONTENT_PSW', L('_MESSAGE_CONTENT_PSW_'), L('_MSG_VERICODE_ACCOUNT_'))
            ->keyTextArea('SMS_CONTENT_MOB', L('_MESSAGE_CONTENT_MOB_'), L('_MSG_VERICODE_ACCOUNT_'))
            ...
            ->keyInteger('INIT_USER_NUMBER', '一次初始化没有身份的用户数量', '根据服务器性能谨慎配置，容易导致报错')->keyDefault('INIT_USER_NUMBER',200)
            ...
            ->group(L('_REGISTER_CONFIGURATION_'), 'REGISTER_TYPE,REG_SWITCH,EMAIL_VERIFY_TYPE,MOBILE_VERIFY_TYPE,REG_STEP,REG_CAN_SKIP,NEW_USER_FOLLOW,NEW_USER_FANS,NEW_USER_FRIENDS')
            ...
            ->group(L('_SMS_CONFIGURATION_'), 'SMS_HTTP,SMS_UID,SMS_PWD,SMS_CONTENT,SMS_HOOK,SMS_RESEND,SMS_CONTENT_PSW,SMS_CONTENT_MOB')
            ->group(L('_BASIC_SETTINGS_'), 'RANK_LIST,LEVEL,NICKNAME_MIN_LENGTH,NICKNAME_MAX_LENGTH,USERNAME_MIN_LENGTH,USERNAME_MAX_LENGTH,INIT_USER_NUMBER,UCENTER_KANBAN')
