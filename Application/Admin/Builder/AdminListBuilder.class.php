...
//            $this->setSearchPostUrl('');
    ...
    public function keyEtherscan($name, $title, $opt = null)
    {
        return $this->key($name, text($title), 'walletaddress', $opt);
    }
    ...
    public function display($solist = '')
    {
        ...
        //wallet_address转换成text
        $this->convertKey('walletaddress', 'text', function ($value) {
...
//    public function blankUrl($url,$flag = 'id'){
//        return $this->key('blankUrl',$url,$flag)
//    }
