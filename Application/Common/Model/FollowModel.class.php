...
class FollowModel extends Model
{
     ...
     * @return int|mixed
     */
    public function follow($whoFollow, $to_uid, &$errMsg = "")
    {
        $follow['who_follow'] = $whoFollow;
        $follow['follow_who'] = $to_uid;
        ...
        clean_query_user_cache($to_uid, 'fans');
        clean_query_user_cache($whoFollow, 'following');
//        /**
...
//         */
//        $user = query_user(array('id', 'nickname', 'space_url'), $uid);
//
//        D('Common/Message')->sendMessage($uid, L('_FANS_NUMBER_INCREASED_'), $user['nickname'] . L('_CONCERN_YOU_WITH_PERIOD_'), 'Ucenter/Index/index', array('uid' => $uid, -1, 'Ucenter'));
     ...
     * @return mixed
     */
    public function unfollow($whoFollow, $uid, &$errMsg = "")
    {
        $follow['who_follow'] = $whoFollow;
...
//        $user = query_user(array('id', 'nickname', 'space_url'), $uid);
//
//        D('Message')->sendMessage($uid, L('_NUMBER_OF_FANS_'), $user['nickname'] . L('_CANCEL_YOUR_ATTENTION_WITH_PERIOD_'), 'Ucenter/Index/index', array('uid' => $uid, -1, 'Ucenter'));
    ...
    public function getTotalFans($uid)
    {
        $map['follow_who'] = $uid;
    ...
    public function getTotalFollow($uid)
    {
        $map['who_follow'] = $uid;
